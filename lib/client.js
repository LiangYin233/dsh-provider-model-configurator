...
function ModelConfiguratorPage(props) {
  ...
  const [form, setForm] = React.useState({ id: "", name: "", contextWindow: "", maxTokens: "", inputText: true, inputImage: false, reasoningMode: "off", levels: [], compatThinkingFormat: "", compatSupportsReasoningEffort: "" });
