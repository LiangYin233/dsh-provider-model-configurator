...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var INVOCATIONS = [
      ...
      {
        id: 'dsh-model-config-sync#modelConfigSync/deleteModel',
        service: 'modelConfigSync',
        namespace: 'modelConfigSync',
        method: 'deleteModel',
        invocation: { kind: 'direct' },
        parameters: [stringParam('route'), stringParam('modelId')],
        result: { mode: 'strict', typeSymbol: 'dsh-model-config-sync#DeleteModelResult', schema: resultEnvelopeSchema },
      },
    ]
    ...
    var en = {
      ...
      sourceTitle: '1. Copy source (optional, for quick fill)',
